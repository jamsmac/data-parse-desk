...
CREATE TABLE IF NOT EXISTS public.table_schemas (
  ...
  column_type TEXT NOT NULL CHECK (column_type IN ('text', 'number', 'date', 'boolean', 'select', 'multi_select', 'email', 'url', 'phone', 'file', 'relation', 'rollup', 'formula', 'lookup', 'button', 'user', 'rating', 'duration', 'percent', 'barcode', 'qr')),
